        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col px-2 md:px-0 h-full">
            ...
            <Container delay={0.3}>
              <p className="text-base md:text-lg text-muted-foreground text-left mt-2 max-w-2xl">
                At PruneUrl, our mission is to simplify the web by making links
                faster, safer, and more intelligent. From advanced analytics to
                AI-powered protection, we're building the future of link
                management.
              </p>
              <p className="text-base lg:text-lg font-normal text-muted-foreground mt-4">
                Whether you're managing a campaign or building a brand, PruneUrl
                empowers you to take control of every click—securely and
                seamlessly.
              </p>
            </Container>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {MISSION.map((item) => (
              <div
                key={item.heading}
                className="rounded-2xl bg-[#181818] border border-neutral-800 p-4 lg:p-6 flex flex-col justify-start"
              >
